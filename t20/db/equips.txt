...
const kit = [
[1,'Traje do Viajante',18,'T$ 10',1,'Inclui botas, calças ou saias, cinto, camisa de linho e capa com capuz. A roupa padrão de aventureiros.'],
[1,'Mochila',1,'T$ 2',1,'Uma bolsa de lona com tiras para ser carregada nas costas.'],
[1,'Saco de Dormir',1,'T$ 1',5,'Um colchão com uma coberta fina o bastante para ser enrolada e amarrada, é especialmente útil para aventureiros, que nunca sabem onde vão passar a noite. Dormir ao relento sem um acampamento e um saco de dormir diminui sua recuperação de PV e PM (veja página 106).'],
[1,'Adaga',2,'T$ 2',5,'Esta faca afiada é usada por muitos habitantes adultos do Reinado, embora seja favorita de ladrões e assassinos, por ser facilmente escondida (fornece +5 em testes de Ladinagem para ocultá-la). Quando ataca com uma adaga, você pode usar sua Destreza em vez de Força nos testes de ataque. Uma adaga pode ser arremessada.\n\nObservação: Você pode trocar essa arma simples por outra de sua preferência (veja Equipamento Inicial na página 140)']
];